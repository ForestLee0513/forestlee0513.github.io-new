...
const NavItem = ({ children, className, href, ...rest }: INavItem) => {
  ...
  return (
    <Link href={href}>
      <p
        className={`z-[1] bg-background flex justify-start pc:justify-end m-0 py-[20px] pc:py-0 pc:last:pr-0 last:border-b-2 last:pc:border-b-0 px-[5%] pc:px-0 pc:mx-[10px] cursor-pointer ${activeStyle} ${
          className || ""
        }`}
        {...rest}
      >
